...
The examples below intentionally pin the latest published stable release
(`v0.6.8`). Use newer stable `v0.6.x` tags after they are published; use
...
```yaml
- name: Compare VIs
  uses: LabVIEW-Community-CI-CD/compare-vi-cli-action@v0.6.8
  with:
